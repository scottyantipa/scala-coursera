...
class AnagramsSuite extends FunSuite  {
  ...
  test("sentence anagrams: bat is") {
    val sentence = List("bat", "is")
    assert(sentenceAnagrams(sentence) == List(List("is", "bat"), List("is", "tab"), List("bit", "as"), List("as", "bit"), List("bat", "is"), List("tab", "is"), List("baits")) )
  }
